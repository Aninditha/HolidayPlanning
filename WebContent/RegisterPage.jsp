...
<form class="form-goup" role="form" action='Register' method="POST" id="myform" data-toggle="validator">
...
<div class="form-group row" class="form-inline">
					...
					<div class="col-sm-6">
<input required type="password" class="form-control" name="password2" id="password2" placeholder="Repeat Password" autocomplete="off">
</div>
<div class="row">
...
<br />
 <div class="form-group">
        <div class="col-xs-6 col-xs-offset-3">
            <button type="submit" class="col-xs-6 btn btn-primary btn-load btn-lg">Register</button>
